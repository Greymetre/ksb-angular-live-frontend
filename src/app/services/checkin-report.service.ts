...
export interface CheckinRow {[key:string]:any;id:number;checkinDate?:string;checkinTime:string;checkoutDate?:string;checkoutTime:string;timeInterval:string;checkinLatitude:string;checkinLongitude:string;checkoutLatitude:string;checkoutLongitude:string;userId:number;userName:string;employeeStatus:string;employeeCode:string;reportingManager:string;designation:string;division:string;branch:string;customerId:number;customerName:string;customerMobile:string;customerType:string;beatName:string;city:string;district:string;pincode:string;address:string;checkinAddress:string;checkoutAddress:string;distance:string;visitType:string;visitRemark:string;orderQty:number;orderValue:number;uniqueSku:number;uniqueOrders:number;}
export interface CheckinFilter {page:number;pageSize:number;search:string;startDate:string;endDate:string;userId:number|null;divisionId:number|null;branchId:number|null;designationIds:number[];customerId?:number|null;/** '', 'Y' or 'N'. */employeeStatus?:string;}
